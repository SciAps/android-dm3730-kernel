...
#define GPMC_CONFIG1_EXTRACT_DEVICETYPE(val)    (((val) >> 10) & 0x3)
...
#define GPMC_CONFIG1_DEVICETYPE_NOR     GPMC_CONFIG1_DEVICETYPE(GPMC_DEVICETYPE_NOR)
#define GPMC_CONFIG1_DEVICETYPE_NAND    GPMC_CONFIG1_DEVICETYPE(GPMC_DEVICETYPE_NAND)
