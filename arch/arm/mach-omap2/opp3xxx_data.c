...
/* As a work around for 300MHz suspend hangups, we push the VDD1 rail slightly higher in voltage */
//#define OMAP3630_VDD_MPU_OPP50_UV		1012500
#define OMAP3630_VDD_MPU_OPP50_UV		1100000
...
//	VOLT_DATA_DEFINE(OMAP3630_VDD_MPU_OPP50_UV, OMAP3630_CONTROL_FUSE_OPP50_VDD1, 0xf4, 0x0c, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP3630_VDD_MPU_OPP50_UV, OMAP3630_CONTROL_FUSE_OPP100_VDD1, 0xf9, 0x16, OMAP_ABB_NOMINAL_OPP),
...
static struct omap_opp_def __initdata omap3603_opp_def_list[] = {
	/* MPU OPP1 - OPP50 */
	OPP_INITIALIZER("mpu", true, 300000000, OMAP3630_VDD_MPU_OPP50_UV),
	/* MPU OPP2 - OPP100 */
	OPP_INITIALIZER("mpu", true, 600000000, OMAP3630_VDD_MPU_OPP100_UV),
...
int __init omap3_opp_init(void)
{
	...
	if (cpu_is_omap3630())
		if (omap3_has_iva())
			...
			r = omap_init_opp_table(omap3603_opp_def_list,
			     ARRAY_SIZE(omap3603_opp_def_list));	
	else
