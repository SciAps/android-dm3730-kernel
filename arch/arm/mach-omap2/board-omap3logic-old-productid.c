...
int omap3logic_fetch_old_sram_product_id_data(void)
{
...
static int omap3logic_has_murata_wifi_module(void)
{
	...
	wilink_found = omap3logic_wl12xx_exists();
...
#if 0
static int __init omap3logic_fetch_old_production_data(void)
{
	int valid;
	...
	if (valid) {
		omap3logic_create_old_product_id_sysfs();
	}
