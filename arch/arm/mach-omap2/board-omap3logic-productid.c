...
void valid_data_extract_dump(struct product_id_data *p)
{
	...
	if (omap3logic_has_murata_wifi_module())
		valid_product_id_has_wifi_config_data = 0;		// not true for Zoll
}
...
ssize_t product_id_show_lan_macaddr(struct class *class, struct class_attribute *attr, char *buf)
{
...
ssize_t product_id_show_wifi_macaddr(struct class *class, struct class_attribute *attr, char *buf)
{
	return sprintf(buf, "00:08:0e:%02x:%02x:%02x\n",
...
ssize_t product_id_show_part_number(struct class *class, struct class_attribute *attr, char *buf)
{
	int len;
...
ssize_t product_id_show_model_name(struct class *class, struct class_attribute *attr, char *buf)
{
	int len;
...
ssize_t product_id_show_serial_number(struct class *class, struct class_attribute *attr, char *buf)
{
	int len;
...
ssize_t product_id_show_zone2_data(struct class *class, struct class_attribute *attr, char *buf)
{
	int len = 0;
...
ssize_t product_id_show_wifi_config_data(struct class *class, struct class_attribute *attr, char *buf)
{
	int len;
