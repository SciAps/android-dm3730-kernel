...
/* Indicates that only 8 of the 12 data signals are connected */
#define MT9P031_8MSB_ONLY
...
#define		MT9P031_GAIN_MIN			8
#define		MT9P031_GAIN_MAX			1024
#define		MT9P031_GAIN_DEF			8
#define		MT9P031_GAIN_MULT			(1 << 6)
...
{
	//linux 3.2+: return i2c_smbus_read_word_swapped(client, reg);
	s32 value = i2c_smbus_read_word_data(client, reg);
	return (value < 0) ? value : swab16(value);
}

static int mt9p031_write(struct i2c_client *client, u8 reg, u16 data)
{
	//linux 3.2+: return i2c_smbus_write_word_swapped(client, reg, data);
...
#endif /* defined(MT9P031_8MSB_ONLY) */
...
//linux 3.3+: module_i2c_driver(mt9p031_i2c_driver);
static int __init mt9p031_i2c_driver_init(void)
{
	return i2c_add_driver(&mt9p031_i2c_driver);
}
module_init(mt9p031_i2c_driver_init);
static void __exit mt9p031_i2c_driver_exit(void)
{
	i2c_del_driver(&mt9p031_i2c_driver);
}
module_exit(mt9p031_i2c_driver_exit);
