...
/* Code unique to Logic DM3730 Torpedo board with ISP1763. */
#define LOGIC_DM3730_TORPEDO_UNIQUE
...
extern int isp1763_write_done;  /* !0 if write done */
#define ISP1763_TP13	113	/* Read prefetch time (113nS) */
static inline __u32 isp1763_readl(__u32 *reg)
{
#ifdef LOGIC_DM3730_TORPEDO_UNIQUE
	udelay(1);
#endif
	if (isp1763_write_done) {
		ndelay(ISP1763_TP13);
		isp1763_write_done = 0;
	}
	return readl(reg);
}
static inline void isp1763_writel(__u32 val, __u32 *reg)
{
	isp1763_write_done = 1;
	writel(val, reg);
#ifdef LOGIC_DM3730_TORPEDO_UNIQUE
	udelay(1);
#endif
}
static inline __u16 isp1763_readw(__u16 *reg)
{
#ifdef LOGIC_DM3730_TORPEDO_UNIQUE
	udelay(1);
#endif
...
static inline void isp1763_writew(__u16 val, __u16 *reg)
{
	isp1763_write_done = 1;
	writew(val, reg);
#ifdef LOGIC_DM3730_TORPEDO_UNIQUE
